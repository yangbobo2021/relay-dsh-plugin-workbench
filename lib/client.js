window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function AppFrame({ useStore, useSessions, actions, renderSlot, workbench, SessionProvider, detailsUseSessionProvider }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RightColumn, {
						sideOpen,
						details: detailsUseSessionProvider ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionProvider, { children: renderSlot("details", {}) }) : renderSlot("details", {}),
		...
		//#endregion
		//#region src/client/layout/compatible-store.ts
		let store;
		try {
		...
		const defineStore = store.defineStore;
		//#endregion
		...
		function apply(ctx) {
			if (ctx.get("workbench") !== void 0) return;
			...
			ctx.effect(() => {
				...
				const disposeRegistration = ctx.slots.register({
					...
					inject: (actions) => {
						...
						return {
							workbench,
							detailsUseSessionProvider: ctx.get("uiSession") !== void 0
						};
					}
				}, AppFrame);
				return () => {
